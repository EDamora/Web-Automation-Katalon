...
WebUI.setText(findTestObject('Object Repository/Payment/Page_STORE/inputname'), 'Damora')

WebUI.setText(findTestObject('Object Repository/Payment/Page_STORE/inputcountry'), 'Indonesia')

WebUI.setText(findTestObject('Object Repository/Payment/Page_STORE/inputcity'), 'Palembang')

WebUI.setText(findTestObject('Object Repository/Payment/Page_STORE/inputcard'), '082298061228')
